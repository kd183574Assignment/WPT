...
function Properties()
{
    ...
    return(
        <div>
        <NavBar/>
        <h2 className="pade-header">PROPERTIES</h2>
        <Link to='/add-property' className="btn btn-primary"> ADD PROPERTY</Link>
        
        {properties.length == 0 && ( <h3 className="mt-5" style={{textAlign: "center"}}>
        There are not properties at the moment. Please use add property button to add one.
        </h3>
        )}
